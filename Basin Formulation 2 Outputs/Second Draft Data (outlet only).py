# -*- coding: utf-8 -*-
"""
Created on Sun Nov 30 21:52:53 2025
...
calQ= pd.read_csv(r"C:\Users\maryp\Downloads\Data CEE Project\Draft Outlet Only\Outputs\Channel_1_Daily_River-Flow_CAL.csv")
print(calQ.dtypes)
...
calN= pd.read_csv(r"C:\Users\maryp\Downloads\Data CEE Project\Draft Outlet Only\Outputs\Channel_1_Daily_River-Organic-Nitrogen_CAL.csv")
print(calN.dtypes)
...
calP= pd.read_csv(r"C:\Users\maryp\Downloads\Data CEE Project\Draft Outlet Only\Outputs\Channel_1_Daily_River-Soluble-Phosphorus_CAL.csv")
print(calP.dtypes)
...
interQ= pd.read_csv(r"C:\Users\maryp\Downloads\Data CEE Project\Draft Outlet Only\Outputs\Discharge All Interventions (Outlet Only).csv")
print(interQ.dtypes)
...
interN= pd.read_csv(r"C:\Users\maryp\Downloads\Data CEE Project\Draft Outlet Only\Outputs\Nitrogen All Interventions (Outlet Only).csv")
print(interN.dtypes)
...
interP= pd.read_csv(r"C:\Users\maryp\Downloads\Data CEE Project\Draft Outlet Only\Outputs\Phosphorus All Interventions (Outlet Only).csv")
print(interP.dtypes)
